    ...
    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleLogin}>
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e)=> setUserData((user)=> ({...user, name:e.target.value}))}
        />
      </div>
      <div className="mb-4">
        <label
      ...
      <Link href='/login' className='text-sm text-gray-600 hover:text-blue-600 pt-4 inline-block'>Already have account?</Link>
    </form>
  </div>
